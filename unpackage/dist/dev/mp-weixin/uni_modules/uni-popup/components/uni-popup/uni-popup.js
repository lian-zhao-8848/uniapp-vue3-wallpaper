...
const _sfc_main = {
  ...
  mounted() {
    const fixSize = () => {
      const { windowWidth, windowHeight, windowTop, safeArea, screenHeight, safeAreaInsets } = common_vendor.index.getWindowInfo();
  ...
  methods: {
    ...
    open(direction) {
      ...
      if (!this.config[direction]) {
        common_vendor.index.__f__("error", "at uni_modules/uni-popup/components/uni-popup/uni-popup.vue:294", "缺少类型：", direction);
        return;
      }
